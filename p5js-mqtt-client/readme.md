...
There is also a second p5.js example in this directory that [receives MQTT messages](https://tigoe.github.io/mqtt-examples/p5js-mqtt-client/AQISensorReceiver/index.html) from an [SGP30 air quality sensor example](../mqtt-examples/MqttClientAQISender) for the Arduino Nano 33 IoT. Here is a [link to the code for the p5.js client](AQISensorReceiver). This pair of examples is designed to show how to send and receive JSON.
